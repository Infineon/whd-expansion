 ...
 */
extern cy_rslt_t cy_rtos_thread_create(cy_thread_t* thread, cy_thread_entry_fn_t entry_function,
 ...
 */
extern cy_rslt_t cy_rtos_thread_exit(void);
 ...
 */
extern cy_rslt_t cy_rtos_thread_terminate(cy_thread_t* thread);
 ...
 */
extern cy_rslt_t cy_rtos_thread_join(cy_thread_t* thread);
 ...
 *          CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_thread_is_running(cy_thread_t* thread, bool* running);
 ...
 */
extern cy_rslt_t cy_rtos_thread_get_state(cy_thread_t* thread, cy_thread_state_t* state);
 ...
 * @returns The status of thread join request. [\ref CY_RSLT_SUCCESS, \ref CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_thread_get_handle(cy_thread_t* thread);
 ...
 *                                     CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_thread_wait_notification(cy_time_t timeout_ms);
 ...
 */
extern cy_rslt_t cy_rtos_thread_set_notification(cy_thread_t* thread);
 ...
 *
 */
extern cy_rslt_t cy_rtos_thread_get_name(cy_thread_t* thread, const char** thread_name);
 ...
 */
extern cy_rslt_t cy_rtos_scheduler_suspend(void);
 ...
 */
extern cy_rslt_t cy_rtos_scheduler_resume(void);
 ...
 *         CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_mutex_init(cy_mutex_t* mutex, bool recursive);
 ...
 *                    CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_mutex_get(cy_mutex_t* mutex, cy_time_t timeout_ms);
 ...
 *
 */
extern cy_rslt_t cy_rtos_mutex_set(cy_mutex_t* mutex);
 ...
 */
extern cy_rslt_t cy_rtos_mutex_deinit(cy_mutex_t* mutex);
 ...
 *         CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_semaphore_init(cy_semaphore_t* semaphore, uint32_t maxcount, uint32_t initcount);
 ...
 */
extern cy_rslt_t cy_rtos_semaphore_get(cy_semaphore_t* semaphore, cy_time_t timeout_ms);
 ...
 *         CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_semaphore_set(cy_semaphore_t* semaphore);
 ...
 *         CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_semaphore_deinit(cy_semaphore_t* semaphore);
 ...
 */
extern cy_rslt_t cy_rtos_event_init(cy_event_t* event);
 ...
 *         CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_event_setbits(cy_event_t* event, uint32_t bits);
 ...
 */
extern cy_rslt_t cy_rtos_event_clearbits(cy_event_t* event, uint32_t bits);
 ...
 *         CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_event_getbits(cy_event_t* event, uint32_t* bits);
 ...
 *         \ref CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_event_waitbits(cy_event_t* event, uint32_t* bits, bool clear, bool all,
 ...
 */
extern cy_rslt_t cy_rtos_event_deinit(cy_event_t* event);
 ...
 *         CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_queue_init(cy_queue_t* queue, size_t length, size_t itemsize);
 ...
 */
extern cy_rslt_t cy_rtos_queue_put(cy_queue_t* queue, const void* item_ptr, cy_time_t timeout_ms);
 ...
 */
extern cy_rslt_t cy_rtos_queue_get(cy_queue_t* queue, void* item_ptr, cy_time_t timeout_ms);
 ...
 */
extern cy_rslt_t cy_rtos_queue_count(cy_queue_t* queue, size_t* num_waiting);
 ...
 */
extern cy_rslt_t cy_rtos_queue_space(cy_queue_t* queue, size_t* num_spaces);
 ...
 */
extern cy_rslt_t cy_rtos_queue_reset(cy_queue_t* queue);
 ...
 */
extern cy_rslt_t cy_rtos_queue_deinit(cy_queue_t* queue);
 ...
 */
extern cy_rslt_t cy_rtos_timer_init(cy_timer_t* timer, cy_timer_trigger_type_t type,
 ...
 */
extern cy_rslt_t cy_rtos_timer_start(cy_timer_t* timer, cy_time_t num_ms);
 ...
 */
extern cy_rslt_t cy_rtos_timer_stop(cy_timer_t* timer);
 ...
 */
extern cy_rslt_t cy_rtos_timer_is_running(cy_timer_t* timer, bool* state);
 ...
 * @return The status of the deinit request. [\ref CY_RSLT_SUCCESS, \ref CY_RTOS_GENERAL_ERROR]
 */
extern cy_rslt_t cy_rtos_timer_deinit(cy_timer_t* timer);
 ...
 */
extern cy_rslt_t cy_rtos_time_get(cy_time_t* tval);
