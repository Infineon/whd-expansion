...
ifeq ($(filter 89530,$(DEVICE_COMPONENTS)),89530)
	...
	ifeq ($(filter WLAN_MFG_FIRMWARE,$(DEFINES)),WLAN_MFG_FIRMWARE)
		...
		else ifeq ($(filter CYW55513_MOD_PSE84_SOM,$(DEVICE_COMPONENTS))$(filter CYW55513_MOD_PSE84_SOM,$(BSP_COMPONENTS)),CYW55513_MOD_PSE84_SOM)
			CLM_FILE_PATH_NAME := "$(CLM_PATH)/COMPONENT_WIFI6/COMPONENT_55500/COMPONENT_CYW55513_MOD_PSE84_SOM/55500A1-mfgtest.clm_blob"
		else ifeq ($(filter MURATA-2FY,$(DEVICE_COMPONENTS))$(filter MURATA-2FY,$(BSP_COMPONENTS)),MURATA-2FY)
			CLM_FILE_PATH_NAME := "$(CLM_PATH)/COMPONENT_WIFI6/COMPONENT_55500/COMPONENT_MURATA-2FY/55500A1-mfgtest.clm_blob"
		endif
	else
		ifeq ($(filter CYW955513SDM2WLIPA,$(DEVICE_COMPONENTS))$(filter CYW955513SDM2WLIPA,$(BSP_COMPONENTS)),CYW955513SDM2WLIPA)
			...
			CLM_FILE_PATH_NAME := "$(CLM_PATH)/COMPONENT_WIFI6/COMPONENT_55500/COMPONENT_MURATA-2FY/55500A1.clm_blob"
		endif
	endif
	ifeq ($(filter CYW955513SDM2WLIPA,$(DEVICE_COMPONENTS))$(filter CYW955513SDM2WLIPA,$(BSP_COMPONENTS)),CYW955513SDM2WLIPA)
		...
		NVRAM_FILE_PATH_NAME := "$(wildcard $(NVRAM_PATH)/COMPONENT_WIFI6/COMPONENT_55500/COMPONENT_CYW55513_MOD_PSE84_SOM/*.txt)"
	else ifeq ($(filter MURATA-2FY,$(DEVICE_COMPONENTS))$(filter MURATA-2FY,$(BSP_COMPONENTS)),MURATA-2FY)
		NVRAM_FILE_PATH_NAME := "$(wildcard $(NVRAM_PATH)/COMPONENT_WIFI6/COMPONENT_55500/COMPONENT_MURATA-2FY/*.txt)"
	endif
else ifeq ($(filter 55572,$(DEVICE_COMPONENTS)),55572)
    ifeq ($(filter WLAN_MFG_FIRMWARE,$(DEFINES)),WLAN_MFG_FIRMWARE)
